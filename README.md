...
| 🎤 **Voice and circles** | One button for both: a tap switches it between voice and circle, a press-and-hold starts recording. You don't have to keep holding — after that comes a line with cancel and send. A voice message arrives as a button with a progress line and a time; a circle as round video that plays right there in the conversation. |
