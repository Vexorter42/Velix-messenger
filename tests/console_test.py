...
# Эту проверку гоняем в одиночку: она водит консольного клиента
# через настоящий ввод-вывод, а тот под нагрузкой от соседок
# иногда отвечает «Invalid argument» на ровном месте
ПООДИНОЧКЕ = True
