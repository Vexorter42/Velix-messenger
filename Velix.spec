...
#   ffplay/ffmpeg/ffprobe — готовые программы ffmpeg. Видео мы играем
#                библиотекой, а не запуском чужого проигрывателя
ЛИШНИЕ_ФАЙЛЫ = {'ffplay.exe', 'ffmpeg.exe', 'ffprobe.exe'}
